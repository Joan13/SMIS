                            ...
                            <div>
                                ...
                                {parseInt(user_data.poste) !== 6 && parseInt(user_data.poste) !== 3 ?
                                    <div>
                                        ...
                                        <div className="flex items-center ml-5 text-primary-50 mb-3">
                                            <BiEdit style={{ marginRight: 7 }} />
                                            <span onClick={() => set_page(35, "FPC", false, false)} className={`select-no-border ${middle_func === 2 ? "select-no-border-bold" : ""}`}>
                                                Edition des travaux journaliers
                                            </span>
                                        </div>
