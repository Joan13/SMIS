...
import BulletinsType2 from './bulletins_type2_brouillon';
import { CircularProgress } from '@material-ui/core';

let max = 0;
let can_show = false;

class BulletinsBrouillons extends React.Component {
                                                ...
                                                <td valign="top" className="standard-td-right" rowSpan={this.props.classe.data.valeur_colonne + 50} colSpan="3">
                                                    <table style={{ width: '100%' }} className="table-fill">
                                                        <tr>
                                                            ...
                                                            <td style={{ color: 'black', width: '30%', fontWeight: 'bold', textAlign: "center" }}></td>
                                            ...
                                            <tr>
                                                ...
                                                {this.props.classe.data.array_places_1.map((place, index_p) => {
                                                    if (place.pupil_id == pupil.pupil.pupil_id) {
                                                        return (
                                                            <td className="td-border" style={{ fontSize: 11, textAlign: 'center' }}><strong>  /{this.props.classe.data.pupils_count}</strong></td>
                                                        )
                                                    }
                                                })}
									...
									MAX.<br />
                                            ...
                                            {this.props.classe.courses.map((course, index) => {
                                                ...
                                                return [
                                                    ...
                                                    <tr key={index}>
                                                        <td className="td-border" style={{ fontSize: 11, paddingLeft: 10 }}>{course.course_name}</td>
                                                        <td className="td-border" style={{ fontSize: 11, textAlign: 'center' }}><span></span></td>
                                                        <td className="td-border" style={{ fontSize: 11, textAlign: 'center' }}><span></span></td>
...
export default connect(mapStateToProps)(BulletinsBrouillons);
