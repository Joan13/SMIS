                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <table className="full-table-liste">
                                        <caption>
                                            <h4>
                                                FICHE D'OBSERVATION DES POINTS OBTENUS<br />
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style={{ paddingLeft: 10, textAlign: 'left', minWidth: 180 }}>Noms de l'élève</th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}> P1 </th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}>Cond.</th>
                                                <th style={{ paddingLeft: 10, textAlign: 'left', minWidth: 150 }}>Observation</th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}> P2 </th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}>Cond.</th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}>TS1</th>
                                                <th style={{ paddingLeft: 10, textAlign: 'left', minWidth: 150 }}>Observation</th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}> P3 </th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}>Cond.</th>
                                                <th style={{ paddingLeft: 10, textAlign: 'left', minWidth: 150 }}>Observation</th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}> P4 </th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}>Cond.</th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}> TS2 </th>
                                                <th style={{ minWidth: 50, textAlign: 'center' }}> TG </th>
                                                <th style={{ paddingLeft: 10, textAlign: 'left', minWidth: 150 }}>Observation</th>
                                            </tr>
                                        </thead>
                                            ...
                                            return (
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style={{ width: 50, textAlign: 'center' }}>
                                                            {this.render_period_conduite(pupil.pupil_id, 1)}
                                                        </td>
                                                        ...
                                                        <input className="input-marks"
                                                                type="number"
                                                                value={this.render_period_marks(this.state.pupil_id, 3)}
                                                            />
                                                            {this.render_period_marks(pupil.pupil_id, 1)}
                                                        </td> */}
                                                        ...
                                                        <td style={{ width: 50, textAlign: 'center' }}>
                                                            {this.render_period_conduite(pupil.pupil_id, 2)}
                                                        </td>
                                                        ...
                                                        <td style={{ width: 50, textAlign: 'center' }}>
                                                            {this.render_period_conduite(pupil.pupil_id, 3)}
                                                        </td>
                                                        ...
                                                        <td style={{ width: 50, textAlign: 'center' }}>
                                                            {this.render_period_conduite(pupil.pupil_id, 4)}
                                                        </td>
