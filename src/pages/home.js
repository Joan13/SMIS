...
class Home extends Component {
    ...
    timetable_settings() {
        ...
        this.props.dispatch({ type: "SET_TITLE_MAIN", payload: "Configuration des horaires" });
        this.props.dispatch({ type: "SET_CLASSE_OPEN", payload: true });
        this.props.dispatch({ type: "SET_ALLOW_RIGHT_MENU_PUPILS", payload: false });
                                    ...
                                    {this.props.allow_right_menu && this.props.class_open ?
                                        <div className="menu-right">
                                            <div>
                                                ...
                                                <div className="item-menu-right">
                                                    <span onClick={() => 
                                                    this.set_page(19,"",true, false)
                                                    } style={{ color: 'rgba(0, 80, 180)' }} className={`select-no-border ${this.props.middle_func === 19 ? "select-no-border-bold" : ""}`}>
                                                ...
                                                <div className="item-menu-right">
                                                    <span
                                                        onClick={() => 
                                                            this.set_page(2,"FPE",false,false)
                                                        }
                                                        style={{ color: 'rgba(0, 80, 180)' }} className={`select-no-border ${this.props.middle_func === 17 ? "select-no-border-bold" : ""}`}>
                                                        <FaEdit style={{ marginRight: 7 }} />
                                                ...
                                                <div className="item-menu-right">
                                                    <span
                                                        onClick={() => 
                                                            this.set_page(2,"FPC",false,false)
                                                        }
                                                        style={{ color: 'rgba(0, 80, 180)' }} className={`select-no-border ${this.props.middle_func === 18 ? "select-no-border-bold" : ""}`}>
                                                        <FaEdit style={{ marginRight: 7 }} />
                                                ...
                                                {/* <div className="item-menu-right">
                                                    <span
                                                        onClick={() => 
                                                            this.set_page(2,"NPE",true,false)
                                                        // this.setState({ middle_func: 9, marks_tab: "", allow_right_menu: true })
                                                        }
                                                        style={{ color: 'rgba(0, 80, 180)' }} className={`select-no-border ${this.props.middle_func === 20 ? "select-no-border-bold" : ""}`}>
                                                        <FaClipboard style={{ marginRight: 7 }} />
                                                ...
                                                <div className="item-menu-right">
                                                    <span
                                                        onClick={() => 
                                                            this.set_page(2,"NPC",true,false)}
                                                        style={{ color: 'rgba(0, 80, 180)' }} className={`select-no-border ${this.props.middle_func === 20 ? "select-no-border-bold" : ""}`}>
                                                        <FaClipboard style={{ marginRight: 7 }} />
                                                        Fiche des points
                                                    </span>
                                                ...
                                                <div className="item-menu-right">
                                                    <span 
                                                    onClick={() => this.set_page1(21,'',"",true,true)}
                                                    // onClick={() => this.setState({ middle_func: 8, marks_tab: "", allow_right_menu: true })} 
                                                    style={{ color: 'rgba(0, 80, 180)' }} className={`select-no-border ${this.props.middle_func === 21 ? "select-no-border-bold" : ""}`}>
                                                        <FaClipboard style={{ marginRight: 7 }} />
