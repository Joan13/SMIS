...
export default function Footer() {
    ...
    return (
        <div className='bg-background-100 text-text-100 dark:text-background-100'>
            <div className="footer-rights bg-background-100 rounded-br-lg dark:bg-background-20 pr-5">
