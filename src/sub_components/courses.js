...
if (this.props.classes[i].id_classes === classe.id_classes) {
    ...
    delete_course_ask(course_id) {
        this.setState({
            ...
            modal_main_text: "Voulez-vous vraiment supprimer ce cours ? Si vous le supprimer, toutes les données y attachées seront perdues. NB.: Cette action est irreversible, vous ne pourrez plus revenir en arrière.",
            modal_view: true
        });
    }
