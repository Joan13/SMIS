                        ...
                        <tr>
                            <td style={{ paddingRight: 0, textAlign: 'left' }}>
                                <TextField
                                    ...
                                    style={{ width: '95%' }}>
                                    <MenuItem selected value="0">Normal</MenuItem>
                                    <MenuItem value="1">Nouveau (N)</MenuItem>
                                    <MenuItem value="1">Reddoublant (D)</MenuItem>
                                    <MenuItem value="1">Nouveau reddoublant (ND)</MenuItem>
                                </TextField>
                            </td>
                            <td style={{ paddingLeft: 0, textAlign: 'right' }}>
                            </td>
                        ...
                        <tr>
                            <td style={{ paddingRight: 0, textAlign: 'left' }}>
                                <TextField
                                    ...
                                    style={{ width: '95%' }}>
                                    <MenuItem value="0">Les deux parents en vie</MenuItem>
                                    <MenuItem value="1">Seul le père en vie</MenuItem>
                                    <MenuItem value="1">Seule la mère en vie</MenuItem>
                                    <MenuItem value="1">Les deux parents dècédés</MenuItem>
                                </TextField>
                            </td>
                            <td style={{ paddingLeft: 0, textAlign: 'right' }}>
                                <TextField
                                    ...
                                    style={{ width: '95%', textAlign: 'left' }}>
                                    <MenuItem value="0">Ensemble</MenuItem>
                                    <MenuItem value="1">Divorcés</MenuItem>
                        ...
                        <tr>
                            <td style={{ paddingRight: 0, textAlign: 'left' }}>
                                <TextField
                                    ...
                                    variant="outlined"
                                    style={{ width: '95%' }}>
                                    <MenuItem value="0">Les deux parents</MenuItem>
                                    <MenuItem value="1">Le père</MenuItem>
                                    <MenuItem value="1">La mère</MenuItem>
                                </TextField>
                            </td>
                            <td style={{ paddingLeft: 0, textAlign: 'right' }}>
                            </td>
